...
import existingSHAs from "./wpt-shas.json" with { type: "json" };
...
async function main() {
  ...
  for (const week of WEEKS) {
    ...
    // Make sure the week is fully in the past.
  ...
  await fs.writeFile("./wpt-shas.json", JSON.stringify(existingSHAs, null, 2));
}
